...
//------------------------------------
//  EJECUTAR FUNCIONES PARA IMPRIMIR
//------------------------------------
parchearArray(arrayProductos);
dibujar(arrayFormateado);

//funcion que formatea el array
// ----------------------------
...
//----------------------------------------
//   AÑADIR PRODUCTOS A LA CESTA POR ID
//----------------------------------------
...
// ----------------------------
// ACTUALIZAR CARRITO CLONAMOS TEMPLATE CARRITO
// ----------------------------
function actualizarCarrito() {
  ...
  carrito.forEach((producto) => {
    ...
    // ✅ eliminar por ID (forma correcta)
